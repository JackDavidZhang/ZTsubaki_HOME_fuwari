...
export const siteConfig: SiteConfig = {
  ...
  banner: {
    ...
    credit: {
      ...
      text: '海と月の少女 りんちゃ',              // Credit text to be displayed
      url: 'https://www.pixiv.net/member_illust.php?mode=medium&illust_id=110962475'                // (Optional) URL link to the original artwork or artist's page
    }
  },
  toc: {
